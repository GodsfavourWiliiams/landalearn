...
import ProgramList from './ProgramCardlist';
...
const dummyData: IDummyData[] = [
  {
    ...
    school: "Bachelor of Science (BSc) in Computer Science",
    course: "University of Lagos",
    status: "ongoing",
  },
  {
    image: "/img/computer-science.png",
...
const Programs = () => {
  return (
    <div className='w-full max-w-4xl'>
        <div className="flex justify-start gap-3 items-center max-w-2xl w-full">
